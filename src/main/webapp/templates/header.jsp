...
<header class="site-navbar" style = "z-index:1;" role="banner">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                    <div class="site-logo">
                        <a href="index.jsp" class="js-logo-clone">Zara Cloth's Store</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 order-3 order-md-3 text-right">
                    <div class="site-top-icons">
                        <ul>
                            ...
                            <c:if test="${sessionScope.account == null}">
                                <li><a href="login.jsp" class  ="btn btn-primary text-white"><span class="icon icon-person"></span>Login</a></li>
                            </c:if>
                            ...
                            <li>
                                <a href="cart.jsp" class="site-cart">
                                    ...
                                    <c:if test="${order.cartProducts.size() != null && sessionScope.account != null && account.getIsAdmin() != 1}">
